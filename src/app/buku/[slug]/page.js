            ...
            <div className={styles.novelInfo}>
              ...
              {isOwner && (
                <div className={styles.ownerActions}>
                  <Link href={`/dashboard/buku/${novel.id}`} className={styles.editBtn}>
                    Edit E-book
                  </Link>
                </div>
              )}
              ...
              {chapters.map(chapter => (
                <div key={chapter.id} className={styles.chapterItem}>
                  ...
                  <div className={styles.chapterActions}>
                    {isOwner && (
                      <Link href={`/dashboard/buku/${novel.id}?chapter=${chapter.id}`} className={styles.editChapterBtn}>
                        Edit
                      </Link>
                    )}
                    <Link
                      href={user ? `/buku/${novelSlug}/chapter/${chapter.id}` : '/auth'}
